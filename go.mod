module gitlab.com/rarify-protocol/near-bridge-go

go 1.19

require (
	github.com/eteu-technologies/borsh-go v0.3.1
	...
	gitlab.com/rarify-protocol/rarimo-core v0.0.0-20221104135456-b511cdfb9e75
