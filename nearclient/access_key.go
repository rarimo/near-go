...
func (c *Client) AccessKeyView(ctx context.Context, accountID common.AccountID, publicKey common.Base58PublicKey, block BlockCharacteristic) (resp common.AccessKeyView, err error) {
...
func (c *Client) AccessKeyViewList(ctx context.Context, accountID common.AccountID, block BlockCharacteristic) (resp common.AccessKeyList, err error) {
	_, err = c.doRPC(ctx, &resp, "query", block, map[string]interface{}{
