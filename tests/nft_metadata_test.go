...
func TestNftMetadata(t *testing.T) {
	...
	x, _ := cfg.Client.ContractViewCallFunction(context.Background(), cfg.NftAddress, common.ContractNftGet, base64.StdEncoding.EncodeToString(r), nearclient.FinalityFinal())
